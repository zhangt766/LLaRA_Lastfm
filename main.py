...
from model.model_interface_5 import MInterface  # 更新导入路径
...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset', default='lastfm', type=str)  # 修正为 lastfm
    ...
    parser.add_argument('--prompt_path', default='./prompt/artist.txt', type=str)  # 修正路径
